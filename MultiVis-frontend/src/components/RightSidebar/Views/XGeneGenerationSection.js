    ...
    return (
        <div className={style.outer}>
            <div className={style.content}>
                ...
                <p className={style.note}>Ensure the the length is always less than 5 milions base pairs.</p>
                </div>
...
export default XGeneGenerationSection;
